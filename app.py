...
def calculate_complex():
    ...
    if operation == 'add':
        result_real, result_imaginary = complex_numbers.add_complex(real_part1, imaginary_part1, real_part2, imaginary_part2)
    elif operation == 'subtract':
        result_real, result_imaginary = complex_numbers.subtract_complex(real_part1, imaginary_part1, real_part2, imaginary_part2)
    elif operation == 'multiply':
        result_real, result_imaginary = complex_numbers.multiply_complex(real_part1, imaginary_part1, real_part2, imaginary_part2)
...
def history():
    ...
    calculations = collection.find(filters).sort(sort_key, sort_direction)
